...
public class TagNotUsedProvider extends AbstractQueryProvider {
	...
	public TagNotUsedProvider(@NonNull ListProvider contentProvider, @NonNull ContentHelper contentHelper, Logger logger, @NonNull UriMatcher uriMatcher, int code) {
